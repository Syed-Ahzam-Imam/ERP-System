...
import { createNewSale, recordReturnSale } from "../../../../api/saleAPI";
import { getAllCustomers } from "../../../../api/customerAPI";
import { addNewSale } from "../../../../api/saleAPI";
import { branchId, role } from "../../../../api/constants";

function ReturnSale({ handleAddUpdateDeleteItem, onClose }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await recordReturnSale(salePayload);
      toast({
        title: "Sale Added",
          ...
          <Box borderWidth="1px" p={2} borderRadius="md" width="100%">
            ...
            {customerSearchTerm && customerSearchResults.length > 0 && (
              <VStack
                ...
                mt={1}
              >
                {customerSearchResults.map((result, resultIndex) => (
                  <Box
                    key={resultIndex}
                    p={2}
                    bg={bgColorChild}
                    ...
                    onClick={() => {
                      ...
                      setSelectedCustomer(result); // Step 4: Set the selected customer object
