...
const RecordExpense = ({ onClose, handleAddUpdateDeleteItem }) => {
  ...
  const handleRecordExpense = async () => {
    ...
    try {
      ...
      if (error.response && error.response.data && error.response.data.error) {
        ...
        toast({
          title: "Error",
          description: "Failed to add expense record. Please try again later.",
          status: "error",
          position: "top-right",
          duration: 3000,
          isClosable: true,
    ...
    >
      <FormControl isRequired>
        ...
        <Flex gap={2} mt={2} direction="column">
          ...
          <Box>
            <FormLabel fontWeight="semibold">Paid Amount</FormLabel>
            <InputGroup>
              <InputLeftElement>
                <FaRupeeSign />
              </InputLeftElement>
